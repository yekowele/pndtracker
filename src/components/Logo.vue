<template>
  <div class="logo">
    ...
    <svg version="1.1" width="64px" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
...
<circle style="fill:#383A3A;" cx="256" cy="256" r="256"/>
	...
	c79.975,0,144.808-54.993,144.808-122.828S335.975,153.86,256,153.86z"/>
      <ellipse transform="matrix(-0.2444 -0.9697 0.9697 -0.2444 -46.7551 550.5992)" style="fill:#63696B;" cx="191.146"
               cy="293.516" rx="32.979" ry="41.616"/>
      <circle style="fill:#1E262B;" cx="198.973" cy="293.495" r="8.189"/>
      <ellipse transform="matrix(-0.2444 0.9697 -0.9697 -0.2444 683.8398 54.1205)" style="fill:#515556;" cx="320.834"
               cy="293.496" rx="32.979" ry="41.616"/>
